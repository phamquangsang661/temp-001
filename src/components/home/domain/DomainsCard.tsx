    ...
    `}
      >
        ...
        <div className="content text-center mt-[40px] w-[calc(100vw-64px)] max-w-[500px] lg:text-start md:flex md:flex-col lg:items-start">
          <h2 className="font-bold text-center text-[30px] md:text-[44px] md:leading-[48px] md:p-0 px-0 leading-[36px]">
            {title}
          </h2>
          <p className="leading-[24px] text-center font-normal  md:text-[16px] md:pt-[8px] md:p-0 tracking-[-0.5px]">
            {content}
          </p>
          {/* button */}
          <ButtonOutline
